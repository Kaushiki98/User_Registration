...
public class UserRegistrationTest {
    ...
    public void MobileHappy(){
        boolean result=userRegistration.PhoneValidation("91 9981234456");
        Assert.assertTrue(result);
    }
    @Test
    public void MobileSad(){
        boolean result=userRegistration.PhoneValidation("8975891291");
        Assert.assertFalse(result);
    }
    @Test
    public void PasswordHappy(){
        boolean result=userRegistration.passwordValidation("Abcdbd#34");
        Assert.assertTrue(result);
    }
    @Test
    public void PasswordSad(){
        boolean result=userRegistration.passwordValidation("abcders");
        Assert.assertFalse(result);
    }
